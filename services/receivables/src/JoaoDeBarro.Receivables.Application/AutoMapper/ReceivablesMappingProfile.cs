...
public class ReceivablesMappingProfile : Profile
{
    public ReceivablesMappingProfile()
    {
        CreateMap<Receivable, ReceivableDto>()
            ...
            .ForMember(d => d.InssAmount, opt => opt.MapFrom(s => s.InssAmount.Amount))
        ...
        CreateMap<ReceivableDto, Receivable>()
            .ConstructUsing(dto => new Receivable(
                ...
                Money.Of(dto.InssAmount, dto.CurrencyCode)))
            ...
            .AfterMap((dto, entity) =>
            {
                ...
                if (dto.AmountReceived > 0)
                    entity.RegisterReceipt(Money.Of(dto.AmountReceived, dto.CurrencyCode), dto.PaymentDate);
            });
    }
